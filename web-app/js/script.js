...
(function($, mango, undefined){
	...
	mango.loaded(function(){
		...
		// ! Select boxes
		var $cznSelects = $('select').not('.dualselects').not(".selectWithoutChosen");
	...
	mango.ready(function(){
		...
		mango.utils.preload([
            imagenRuta+'/img/layout/navigation/arrow-active.png',
            imagenRuta+'img/layout/navigation/arrow-hover.png',
            imagenRuta+'img/layout/navigation/arrow.png',
            imagenRuta+'img/layout/navigation/bg-current.png',
            imagenRuta+'img/layout/navigation/bg-active.png',
            imagenRuta+'img/layout/navigation/bg-hover.png',
            imagenRuta+'img/layout/navigation/bg-normal.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/layout/sidebar/bg-right.png',
            imagenRuta+'img/layout/sidebar/bg.png',
            imagenRuta+'img/layout/sidebar/divider.png',
            imagenRuta+'img/layout/sidebar/shadow-right.png',
            imagenRuta+'img/layout/sidebar/shadow.png',
            imagenRuta+'img/layout/sidebar-right/header-bg.png',
            imagenRuta+'img/layout/sidebar-right/nav-bg-hover.png',
            imagenRuta+'img/layout/sidebar-right/nav-bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/layout/toolbar/bg.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-active.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-disabled.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-hover.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-red-active.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-red-disabled.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-red-hover.png',
            imagenRuta+'img/layout/toolbar/buttons/bg-red.png',
            imagenRuta+'img/layout/toolbar/buttons/bg.png',
            imagenRuta+'img/layout/toolbar/buttons/divider.png'
		]);
		
		mango.utils.preload([imagenRuta+'img/layout/footer/divider.png']);
		
				
		mango.utils.preload([
            imagenRuta+'img/layout/bg.png',
            imagenRuta+'img/layout/content/box/actions-bg.png',
            imagenRuta+'img/layout/content/box/bg.png',
            imagenRuta+'img/layout/content/box/header-bg.png',
            imagenRuta+'img/layout/content/box/menu-active-bg.png',
            imagenRuta+'img/layout/content/box/menu-arrow.png',
            imagenRuta+'img/layout/content/box/menu-bg.png',
            imagenRuta+'img/layout/content/box/menu-item-bg-hover.png',
            imagenRuta+'img/layout/content/box/menu-item-bg.png',
            imagenRuta+'img/layout/content/box/tab-hover.png',
            imagenRuta+'img/layout/content/toolbar/bg-shortcuts.png',
            imagenRuta+'img/layout/content/toolbar/bg.png',
            imagenRuta+'img/layout/content/toolbar/divider.png',
            imagenRuta+'img/layout/content/toolbar/popup-arrow.png',
            imagenRuta+'img/layout/content/toolbar/popup-header.png',
            imagenRuta+'img/layout/content/toolbar/user/arrow-normal.png',
            imagenRuta+'img/layout/content/toolbar/user/avatar-bg.png',
            imagenRuta+'img/layout/content/toolbar/user/avatar.png',
            imagenRuta+'img/layout/content/toolbar/user/bg-hover.png',
            imagenRuta+'img/layout/content/toolbar/user/bg-menu-hover.png',
            imagenRuta+'img/layout/content/toolbar/user/counter.png'
		]);
		
		
		mango.utils.preload([
            imagenRuta+'img/elements/alert-boxes/bg-error.png',
            imagenRuta+'img/elements/alert-boxes/bg-information.png',
            imagenRuta+'img/elements/alert-boxes/bg-note.png',
            imagenRuta+'img/elements/alert-boxes/bg-success.png',
            imagenRuta+'img/elements/alert-boxes/bg-warning.png',
            imagenRuta+'img/elements/alert-boxes/error.png',
            imagenRuta+'img/elements/alert-boxes/information.png',
            imagenRuta+'img/elements/alert-boxes/note.png',
            imagenRuta+'img/elements/alert-boxes/success.png',
            imagenRuta+'img/elements/alert-boxes/warning.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/breadcrumb/bg-active.png',
            imagenRuta+'img/elements/breadcrumb/bg-hover.png',
            imagenRuta+'img/elements/breadcrumb/divider-active.png',
            imagenRuta+'img/elements/breadcrumb/divider-hover.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/headerbuttons/bg-active.png',
            imagenRuta+'img/elements/headerbuttons/bg-hover.png'
		]);
	
		mango.utils.preload([
            imagenRuta+'img/elements/autocomplete/el-bg-hover.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/calendar/arrow-hover-bg.png'
		]);
		
		mango.utils.preload([imagenRuta+'img/elements/charts/hover-bg.png']);
		
		mango.utils.preload([
            imagenRuta+'img/elements/messages/button-active-bg.png',
            imagenRuta+'img/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
            imagenRuta+'img/elements/mail/actions-bg.png',
            imagenRuta+'img/elements/mail/button-bg-disabled.png',
            imagenRuta+'img/elements/mail/button-bg-hover.png',
            imagenRuta+'img/elements/mail/button-bg.png',
            imagenRuta+'img/elements/mail/button-red-bg-hover.png',
            imagenRuta+'img/elements/mail/button-red-bg.png',
            imagenRuta+'img/elements/mail/button-red-disabled.png',
            imagenRuta+'img/elements/mail/hover-bg.png',
            imagenRuta+'img/elements/mail/mail.png',
            imagenRuta+'img/elements/mail/text-arrow.png',
            imagenRuta+'img/elements/mail/text-bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/fullstats/list/hover-bg.png',
            imagenRuta+'img/elements/fullstats/simple/a-active.png',
            imagenRuta+'img/elements/fullstats/simple/a-hover.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/checkbox/checked-active.png',
            imagenRuta+'img/elements/checkbox/checked-disabled.png',
            imagenRuta+'img/elements/checkbox/checked-hover.png',
            imagenRuta+'img/elements/checkbox/checked-normal.png',
            imagenRuta+'img/elements/checkbox/unchecked-active.png',
            imagenRuta+'img/elements/checkbox/unchecked-disabled.png',
            imagenRuta+'img/elements/checkbox/unchecked-hover.png',
            imagenRuta+'img/elements/checkbox/unchecked-normal.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/radiobutton/checked-active.png',
            imagenRuta+'img/elements/radiobutton/checked-disabled.png',
            imagenRuta+'img/elements/radiobutton/checked-hover.png',
            imagenRuta+'img/elements/radiobutton/checked-normal.png',
            imagenRuta+'img/elements/radiobutton/unchecked-active.png',
            imagenRuta+'img/elements/radiobutton/unchecked-disabled.png',
            imagenRuta+'img/elements/radiobutton/unchecked-hover.png',
            imagenRuta+'img/elements/radiobutton/unchecked-normal.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/colorpicker/arrow.png',
            imagenRuta+'img/elements/colorpicker/bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/forms/icon-error.png',
            imagenRuta+'img/elements/forms/icon-success.png',
            imagenRuta+'img/elements/forms/tooltip-error-arrow.png',
            imagenRuta+'img/elements/forms/tooltip-error.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/profile/change-active-bg.png',
            imagenRuta+'img/elements/profile/change-hover-bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/search/arrow.png',
            imagenRuta+'img/elements/search/glass.png',
            imagenRuta+'img/elements/search/list-hover.png',
            imagenRuta+'img/elements/search/loading.gif'
		]);

		mango.utils.preload([
            imagenRuta+'img/elements/select/bg-active.png',
            imagenRuta+'img/elements/select/bg-hover.png',
            imagenRuta+'img/elements/select/bg-right-hover.png',
            imagenRuta+'img/elements/select/list-hover-bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/settings/header-bg.png',
            imagenRuta+'img/elements/settings/header-current-bg.png',
            imagenRuta+'img/elements/settings/header-hover-bg.png',
            imagenRuta+'img/elements/settings/seperator-current-left.png',
            imagenRuta+'img/elements/settings/seperator-current-right.png',
            imagenRuta+'img/elements/settings/seperator.png'
		]);

		mango.utils.preload([
            imagenRuta+'img/elements/slide-unlock/lock-slider.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/spinner/arrow-down-active.png',
            imagenRuta+'img/elements/spinner/arrow-down-hover.png',
            imagenRuta+'img/elements/spinner/arrow-up-active.png',
            imagenRuta+'img/elements/spinner/arrow-up-hover.png',
            imagenRuta+'img/elements/table/pagination/active.png',
            imagenRuta+'img/elements/table/pagination/disabled.png',
            imagenRuta+'img/elements/table/pagination/hover.png',
            imagenRuta+'img/elements/table/toolbar/hover.png',
            imagenRuta+'img/elements/table/sorting-asc.png',
            imagenRuta+'img/elements/table/sorting-desc.png',
            imagenRuta+'img/elements/table/sorting.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/tags/bg.png',
            imagenRuta+'img/elements/tags/left.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/to-top/active.png',
            imagenRuta+'img/elements/to-top/hover.png',
            imagenRuta+'img/elements/to-top/normal.png'
		]);
		
		mango.utils.preload([imagenRuta+'img/elements/tooltips/bg.png']);
		
		mango.utils.preload([
            imagenRuta+'img/elements/upload/bg-hover.png',
            imagenRuta+'img/elements/upload/bg-normal.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/elements/wizard/arrow-current.png',
            imagenRuta+'img/elements/wizard/arrow-error.png',
            imagenRuta+'img/elements/wizard/arrow-normal.png',
            imagenRuta+'img/elements/wizard/arrow-success.png',
            imagenRuta+'img/elements/wizard/bg-current.png',
            imagenRuta+'img/elements/wizard/bg-error.png',
            imagenRuta+'img/elements/wizard/bg-normal.png',
            imagenRuta+'img/elements/wizard/bg-success.png',
            imagenRuta+'img/elements/wizard/bg.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/chosen-sprite.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/colorpicker/blank.gif',
            imagenRuta+'img/external/colorpicker/colorpicker_background.png',
            imagenRuta+'img/external/colorpicker/colorpicker_hex.png',
            imagenRuta+'img/external/colorpicker/colorpicker_hsb_b.png',
            imagenRuta+'img/external/colorpicker/colorpicker_hsb_h.png',
            imagenRuta+'img/external/colorpicker/colorpicker_hsb_s.png',
            imagenRuta+'img/external/colorpicker/colorpicker_indic.gif',
            imagenRuta+'img/external/colorpicker/colorpicker_overlay.png',
            imagenRuta+'img/external/colorpicker/colorpicker_rgb_b.png',
            imagenRuta+'img/external/colorpicker/colorpicker_rgb_g.png',
            imagenRuta+'img/external/colorpicker/colorpicker_rgb_r.png',
            imagenRuta+'img/external/colorpicker/colorpicker_select.gif',
            imagenRuta+'img/external/colorpicker/colorpicker_submit.png',
            imagenRuta+'img/external/colorpicker/custom_background.png',
            imagenRuta+'img/external/colorpicker/custom_hex.png',
            imagenRuta+'img/external/colorpicker/custom_hsb_b.png',
            imagenRuta+'img/external/colorpicker/custom_hsb_h.png',
            imagenRuta+'img/external/colorpicker/custom_hsb_s.png',
            imagenRuta+'img/external/colorpicker/custom_indic.gif',
            imagenRuta+'img/external/colorpicker/custom_rgb_b.png',
            imagenRuta+'img/external/colorpicker/custom_rgb_g.png',
            imagenRuta+'img/external/colorpicker/custom_rgb_r.png',
            imagenRuta+'img/external/colorpicker/custom_submit.png',
            imagenRuta+'img/external/colorpicker/select.png',
            imagenRuta+'img/external/colorpicker/select2.png',
            imagenRuta+'img/external/colorpicker/slider.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/editor/buttons.gif',
            imagenRuta+'img/external/editor/toolbar.gif'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/explorer/arrows-active.png',
            imagenRuta+'img/external/explorer/arrows-normal.png',
            imagenRuta+'img/external/explorer/crop.gif',
            imagenRuta+'img/external/explorer/dialogs.png',
            imagenRuta+'img/external/explorer/icons-big.png',
            imagenRuta+'img/external/explorer/icons-small.png',
            imagenRuta+'img/external/explorer/logo.png',
            imagenRuta+'img/external/explorer/progress.gif',
            imagenRuta+'img/external/explorer/quicklook-bg.png',
            imagenRuta+'img/external/explorer/quicklook-icons.png',
            imagenRuta+'img/external/explorer/resize.png',
            imagenRuta+'img/external/explorer/spinner-mini.gif',
            imagenRuta+'img/external/explorer/toolbar.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/gallery/blank.gif',
            imagenRuta+'img/external/gallery/fancybox_buttons.png',
            imagenRuta+'img/external/gallery/fancybox_loading.gif',
            imagenRuta+'img/external/gallery/fancybox_sprite.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
            imagenRuta+'img/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_222222_256x240.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_2e83ff_256x240.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_3a4450_256x240.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_454545_256x240.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_888888_256x240.png',
            imagenRuta+'img/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/external/uploader/backgrounds.gif',
            imagenRuta+'img/external/uploader/buttons-disabled.png',
            imagenRuta+'img/external/uploader/buttons.png',
            imagenRuta+'img/external/uploader/delete.gif',
            imagenRuta+'img/external/uploader/done.gif',
            imagenRuta+'img/external/uploader/error.gif',
            imagenRuta+'img/external/uploader/throbber.gif',
            imagenRuta+'img/external/uploader/transp50.png'
		]);
		
		mango.utils.preload([
            imagenRuta+'img/jquery-ui/accordion-header-active.png',
            imagenRuta+'img/jquery-ui/accordion-header-hover.png',
            imagenRuta+'img/jquery-ui/accordion-header.png',
            imagenRuta+'img/jquery-ui/datepicker/arrow-left.png',
            imagenRuta+'img/jquery-ui/datepicker/arrow-right.png',
            imagenRuta+'img/jquery-ui/datepicker/button-bg.png',
            imagenRuta+'img/jquery-ui/datepicker/button-hover-bg.png',
            imagenRuta+'img/jquery-ui/datepicker/button-seperator.png',
            imagenRuta+'img/jquery-ui/datepicker/day-current.png',
            imagenRuta+'img/jquery-ui/datepicker/day-hover.png',
            imagenRuta+'img/jquery-ui/datepicker/days-of-week-bg.png',
            imagenRuta+'img/jquery-ui/datepicker/header-bg.png',
            imagenRuta+'img/jquery-ui/datepicker/time-bg.png',
            imagenRuta+'img/jquery-ui/datepicker/top-arrow.png',
            imagenRuta+'img/jquery-ui/dialog-titlebar-close-hover.png',
            imagenRuta+'img/jquery-ui/dialog-titlebar.png',
            imagenRuta+'img/jquery-ui/loading.gif',
            imagenRuta+'img/jquery-ui/progressbar/bg.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-blue-small.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-blue.gif',
            imagenRuta+'img/jquery-ui/progressbar/fill-blue.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-grey.gif',
            imagenRuta+'img/jquery-ui/progressbar/fill-grey.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-orange-small.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-orange.gif',
            imagenRuta+'img/jquery-ui/progressbar/fill-orange.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-red-small.png',
            imagenRuta+'img/jquery-ui/progressbar/fill-red.gif',
            imagenRuta+'img/jquery-ui/progressbar/fill-red.png',
            imagenRuta+'img/jquery-ui/slider/bg-range.png',
            imagenRuta+'img/jquery-ui/slider/bg.png',
            imagenRuta+'img/jquery-ui/slider/disabled-bg-range.png',
            imagenRuta+'img/jquery-ui/slider/disabled-bg.png',
            imagenRuta+'img/jquery-ui/slider/disabled-picker.png',
            imagenRuta+'img/jquery-ui/slider/disabled-vertical-bg-range.png',
            imagenRuta+'img/jquery-ui/slider/disabled-vertical-bg.png',
            imagenRuta+'img/jquery-ui/slider/disabled-vertical-picker.png',
            imagenRuta+'img/jquery-ui/slider/picker.png',
            imagenRuta+'img/jquery-ui/slider/vertical-bg-range.png',
            imagenRuta+'img/jquery-ui/slider/vertical-bg.png',
            imagenRuta+'img/jquery-ui/slider/vertical-picker.png'
		]);
